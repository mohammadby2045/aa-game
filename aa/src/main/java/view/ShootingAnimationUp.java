...
public class ShootingAnimationUp extends Transition {
    private Pane pane;
    private Canon rocket;
    private Ball laser;
    private ProgressBar progressBar;

    public ShootingAnimationUp(Pane pane, Canon rocket, Ball laser, ProgressBar progressBar) {
        this.pane = pane;
        this.rocket = rocket;
        this.laser = laser;
    ...
    protected void interpolate(double v) {
        ...
        if (meteorite != null && meteorite.getBoundsInParent().intersects(laser.getLayoutBounds())) {
            ...
            Ball ball = new Ball((int) laser.getCenterX(), (int) (30));
